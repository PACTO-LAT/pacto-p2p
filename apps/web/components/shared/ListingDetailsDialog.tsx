          ...
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <p className="font-medium">
                  {formatAmount(listing.amount)} {listing.token}
                </p>
              </div>
              <div>
            ...
            {creatorAddress && (
              <div>
                ...
                <p className="font-mono text-xs bg-muted/50 backdrop-blur-sm px-2 py-1 rounded break-all">
                  {creatorAddress}
                </p>
              </div>
            )}
