...
const techStack = [
  ...
  {
    name: 'Soroban',
    description: 'Stellar native smart contract platform, built to integrate seamlessly with the Stellar network',
    category: 'Core',
      ...
      >
        {techStack.map((tech, index) => {
          ...
          return (
            ...
            >
              <Card 
                className="group relative overflow-hidden bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl border border-white/10 dark:border-white/5 shadow-lg hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-500 hover:-translate-y-2"
              >
                {/* Gradient overlay */}
