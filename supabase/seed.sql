...
VALUES
  (
    ...
    'Alice Demo',
    'alice',
    'Trusted XLM/USDC trader in Costa Rica. Fast and reliable transactions.',
  ...
  (
    ...
    'Bob Demo',
    'bob',
    'Fast USDC swaps via SPEI. Professional trader with high volume.',
  ...
  (
    ...
    'Diana Demo',
    'diana',
    'Premium merchant specializing in XLM. Verified and trusted.',
...
VALUES
  (
    ...
    true,
    'verified',
    'Trusted XLM/USDC trader in Costa Rica. Fast and reliable transactions via SINPE.',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=alice',
  ...
  (
    ...
    true,
    'verified',
    'Fast USDC swaps via SPEI. Professional trader with high volume and quick settlement.',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=bob',
  ...
  (
    ...
    true,
    'verified',
    'Premium merchant specializing in XLM. Verified and trusted with excellent reputation.',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=diana',
  ...
  (
    ...
    true,
    'pending',
    'Crypto exchange looking to expand into P2P trading. Specializing in USDC.',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=eve',
...
VALUES
  ...
  (
    ...
    100.0000000,
    5000.0000000,
    'Selling XLM for CRC via SINPE movil. Fast and secure transactions.',
    'active'
  ),
  (
  ...
  (
    ...
    500.0000000,
    10000.0000000,
    'USDC to MXN via SPEI, fast settlement. High volume available.',
    'active'
  ),
  (
  ...
  (
    ...
    500.0000000,
    15000.0000000,
    'Premium XLM seller. Large volumes available. Verified merchant.',
    'active'
  ),
  (
    ...
    200.0000000,
    8000.0000000,
    'Buying XLM with CRC. Multiple payment methods accepted.',
    'active'
  ),
  -- Paused listing
  (
...
-- ---------------------------------------------------------------------------
-- Sample Escrows (schema: id, listing_id, buyer_id, seller_id, engagement_id, fiat_amount, created_at, updated_at)
-- ---------------------------------------------------------------------------
INSERT INTO escrows (
  id, listing_id, buyer_id, seller_id, engagement_id, fiat_amount
)
VALUES
  (
