...
import { Coins, Plus, Trash2, Settings, Users, TrendingUp, AlertCircle, CheckCircle } from "lucide-react"
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">Manage stablecoins and platform operations</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{platformStats.activeListings}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">${platformStats.totalVolume.toLocaleString()}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{platformStats.completedTrades}</div>
                      ...
                      <div className="grid grid-cols-3 gap-8 text-center">
                        <div>
                          ...
                          <p className="font-semibold">
                            {token.totalSupply > 0 ? token.totalSupply.toLocaleString() : "External"}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-600">Circulating</p>
                          <p className="font-semibold">
                            {token.circulating > 0 ? token.circulating.toLocaleString() : "N/A"}
                          </p>
                        </div>
                        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Issue new stablecoin tokens to a recipient</CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleMint} className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setMintForm((prev) => ({ ...prev, token: value }))}
                      >
                        <SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        value={mintForm.memo}
                        onChange={(e) => setMintForm((prev) => ({ ...prev, memo: e.target.value }))}
                        rows={3}
                      />
                    </div>
                      ...
                      {tokens
                        ...
                        .map((token) => (
                          <div key={token.symbol} className="flex items-center justify-between p-3 border rounded-lg">
                            ...
                            <Button variant="outline" size="sm" onClick={() => handleBurn(token.symbol, 1000)}>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div
                          className={`w-10 h-10 rounded-full flex items-center justify-center ${
                            tx.type === "mint" ? "bg-green-100 text-green-600" : "bg-red-100 text-red-600"
                          }`}
                        >
                          {tx.type === "mint" ? <Plus className="w-5 h-5" /> : <Trash2 className="w-5 h-5" />}
                        </div>
                        <div>
                          <p className="font-medium">
                            {tx.type === "mint" ? "Minted" : "Burned"} {tx.amount.toLocaleString()} {tx.token}
                          </p>
                          <p className="text-sm text-gray-600">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          ...
                          <p className="text-sm text-gray-600">{new Date(tx.timestamp).toLocaleTimeString()}</p>
                        </div>
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  This section will include user verification, KYC management, and account controls
                </p>
              </CardContent>
            </Card>
          </TabsContent>
